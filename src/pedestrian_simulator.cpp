...
#include <mpc_planner_msgs/obstacle_gmm.h>
...
PedestrianSimulator::PedestrianSimulator()
{
    ...
    obstacle_trajectory_prediction_pub_ = nh_.advertise<mpc_planner_msgs::obstacle_array>("/pedestrian_simulator/trajectory_predictions", 1);
